...
import com.lune.yunpicturebackend.model.dto.space.SpaceUpdateRequest;
import com.lune.yunpicturebackend.model.dto.space.analyze.*;
...
import com.lune.yunpicturebackend.model.vo.space.analyze.*;
import com.lune.yunpicturebackend.service.PictureService;
import com.lune.yunpicturebackend.service.SpaceAnalyzeService;
...
public class SpaceAnalyzeServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    public SpaceUsageAnalyzeResponse getSpaceUsageAnalyze(SpaceUsageAnalyzeRequest spaceUsageAnalyzeRequest, User loginUser) {
        ...
        if (spaceUsageAnalyzeRequest.isQueryAll() || spaceUsageAnalyzeRequest.isQueryPublic()) {
            ...
            List<Object> pictureObjList = pictureService.getBaseMapper().selectObjs(queryWrapper); // 实际只返回一个picSize字段，long类型
    ...
    private void checkSpaceAnalyzeAuth(SpaceAnalyzeRequest spaceAnalyzeRequest, User loginUser) {
        ...
        if (queryAll || queryPublic) {
            ...
            Space space = spaceService.getById(spaceId);
            ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR, "空间不存在");
            spaceService.checkSpaceAuth(loginUser, space); // 校验权限
        }
    }
